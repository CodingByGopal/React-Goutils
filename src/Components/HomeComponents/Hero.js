    ...
    <div className=" grid md:grid-cols-9 grid-cols-1  gap-5">
      <div className=" md:col-start-1 md:col-end-7">
        ...
        <p className="  font-thin  text-sm md:text-base mb-5 ">
          GoUtils is a multifunctional utility web app that helps you to create
          and save notes in your browser while working online, Helps in
          analyzing and formatting your text by manipulating it the way you want
          and generating multiplication tables of any number. These tools have
          been designed to help students and professionals in their daily life
