    ...
    <div className="md:pt-32 pt-20 pb-8">
      <Card>
        <PageHeader
          ...
          text="Are you looking for Multiplication table from 1 to 10, 2 to 20, 1 to 50, 1 to 100, 2 to 25? You feel that Table of 13, Table of 17, Table of 19 or any table is complicated? Are you having trouble with Multiplication table? Well, whatever the problem is with the table or पहाड़ा. GoUtils got a complete solution for you. Just type the number in the box and get the table of that number."
        />
